...
$male = "<img src='pics/male.jpg' width='50' height='50'>";
$female = "<img src='pics/female.jpg' width='50' height='50'>";
/*
if(isset($_GET["page"]))
$page = (int)$_GET["page"];
else
...
{
?>   
<tr style="color: #FFF " id="currentRecord">
<td> <?php echo $i++; ?> </td>
...
<td>
<!-- href="./delete_user.php?del_id=<?php //echo $row['user_id'];?>&img=<?php //echo $row['user_image'];?>"  <a href="edit_user.php?id=<?php //echo $row['user_id'];  ?>"><button class="btn btn-primary">Edit</button></a> -->
&nbsp;


<button  data-id="<?php echo $row['user_id']; ?>" class="btn btn-danger delete">Delete</button>
</td>
</tr>
<?php
}
...
<?php
//$(this).parents(".show").animate({ backgroundColor: "blue" }, "slow").animate({ opacity: "hide" }, "slow");
}
?>
...
if(confirm("Are you sure want to delete it "))
{
    $.ajax({
        ...
        {
            del.closest('tr').css('background','tomato').fadeOut();
           del.closest('tr').hide();
